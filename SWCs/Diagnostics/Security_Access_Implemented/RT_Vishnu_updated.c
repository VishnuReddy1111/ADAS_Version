 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  RT_Vishnu.c
 *           Config:  D:/SIPs/CARIAD/E2E/ADAS/02_EcuCfg/ADAS.dpa
 *        SW-C Type:  RT_Vishnu
 *  Generation Time:  2024-10-30 18:51:19
 *
...
static uint8 OverDTC_Flag = 0xFF;
static uint8 Suppress_Status = 0xFF;
static uint32 DTC_mapped = 0xFF;
static uint8 DTC_Type = 0xFF;
static uint8 Record_1_Data[2];
static uint8 Record_2_Data[10];
static uint8 Record_3_Data[2];
static uint8 DTC_Suppression_Status = 0xFF;
static uint32 DTC_ID = 0x000000;
...
Std_TransformerError test;

static uint8 Target_Reset = 0;
 ...
 *********************************************************************************************************************/
  ...
  if(Alive_ounter == 15 && CRC_Count == 15 && Trnellette == 15)
  {
   ...
   (void)Rte_Write_SG_BMC_HV_17_SG_BMC_HV_10(&SG_10_data);
...
// static uint8 FailedAttempts= 0x00;
static uint8 count=0,fail;
...
//   {
//     RT_PIM[0] = TRUE;
//     Rte_Call_PS_CddNpmGen2_MeasurementsType_WriteBlock(&RT_PIM[0]);
//   }
//  else
//  {
//   RT_PIM[0] = FALSE;

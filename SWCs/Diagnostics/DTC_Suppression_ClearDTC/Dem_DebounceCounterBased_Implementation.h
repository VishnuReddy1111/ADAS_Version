  ...
  )
{
  ...
  lEnableConditionsSatisfied = Dem_Conditions_EnableCondition_TestEventEnabled(lEventId);
  ...
  )
{
  ...
  if (lNewDebounceValue == Dem_Cfg_EventFailedTarget(lEventId))
  {
    ...
    if ( (Dem_Conditions_EnableCondition_TestEventEnabled(lEventId) == TRUE)
      && (Dem_Conditions_StorageCondition_TestEventStorageConditionsFulfilled(lEventId) == TRUE) )                                          
    {

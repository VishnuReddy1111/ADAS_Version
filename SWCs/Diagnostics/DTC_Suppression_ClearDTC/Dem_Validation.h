...
#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID1C == STD_ON))
# error "DEM_CFG_SUPPORT_PID1C == STD_ON is not valid for non-OBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID21 == STD_ON))
...
#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID31 == STD_ON))
...
#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID4D == STD_ON))
# error "DEM_CFG_SUPPORT_PID4D == STD_ON is not valid for non-OBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID4E == STD_ON))
# error "DEM_CFG_SUPPORT_PID4E == STD_ON is not valid for non-OBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_PROCESS_PID41_COMPREHENSIVE_COMPLETE == STD_ON))

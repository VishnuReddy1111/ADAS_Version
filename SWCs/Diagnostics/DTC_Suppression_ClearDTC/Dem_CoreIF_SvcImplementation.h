  ...
  )
{
  ...
  else
  {
    ...
    /* all monitors are set to not complete*/
...
# if (DEM_CFG_SUPPORT_AGING_FOR_ALL_DTCS == STD_ON)
    ...
    Dem_MemSet((Dem_DataPtrType)&(Dem_Cfg_GetAgingData().AgingCounter[0]),                                                       /* PRQA S 0310, 0315, 0602 */ /* MD_DEM_11.4_cpy, MD_MSR_VStdLibCopy, MD_DEM_20.2 */ /* SBSW_DEM_MEMSET_AGINGDATA_AGINGCOUNTER */
      0xFF,

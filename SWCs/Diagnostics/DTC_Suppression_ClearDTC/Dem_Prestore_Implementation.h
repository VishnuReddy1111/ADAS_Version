...
/* ****************************************************************************
 % Dem_Prestore_PrestorageEntryGetObdFFDataPtr
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
/* ****************************************************************************
 * Dem_FaultMemory_Prestore_PrestorageEntryLockedForEvent
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_FaultMemory_Prestore_EventHasPrestorageEntryAssigned
 *****************************************************************************/
/*! 
...
)
{
  ...
  if ( (Dem_Prestore_LockedIndex != DEM_PRESTORE_INVALID_BUFFER_ENTRY)
    && (Dem_Prestore_PrestorageEntryGetEventId(Dem_Prestore_LockedIndex) == EventId) )
  {
    lReturnValue = TRUE;
  }
#endif
...
#  if (DEM_CFG_SUPPORT_OBDII == STD_ON)
    if (Dem_Cfg_IsObdIIExclusivelySupportedInVariant() == TRUE)
    {
      Dem_FaultMemory_DataStorage_CollectObdIIFreezeFrame(EventId,
        Dem_Prestore_PrestorageEntryGetObdFFDataPtr(PrestorageEntry),                                                          /* SBSW_DEM_POINTER_PRESTORAGE_OBD_FREEZEFRAME_BUFFER */
...
#  if (DEM_CFG_SUPPORT_WWHOBD == STD_ON)
    ...
    {
      Dem_FaultMemory_DataStorage_CollectEventSpecificOBDFreezeFrame(EventId,                                                    /* SBSW_DEM_POINTER_PRESTORAGE_WWHOBDFREEZEFRAME_BUFFER */
...
/* ****************************************************************************
 % Dem_FaultMemory_Prestore_EventGetFreezeFramePrestored
 *****************************************************************************/
 /*!
  * Internal comment removed.
 *
...
)
{
  ...
  if ( (Dem_FaultMemory_Prestore_PrestorageEntryLockedForEvent(EventId) == TRUE)
    || (Dem_FaultMemory_Prestore_EventHasPrestorageEntryAssigned(EventId) == TRUE) )
  {

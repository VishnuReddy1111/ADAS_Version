...
{
  return (boolean)(Dem_Cfg_IsUseOBDIIOrOBDonUDSInVariant() == TRUE);                                                                       /* PRQA S 2812 */ /* MD_DEM_Dir4.1_NullPointerDereference */
}
...
{
#if (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON)
  return Dem_Cfg_GetMaxNumberEventEntryOBDFreezeFrame();
#else
  return 0u;
#endif
}

...
)
{
  ...
  Dem_FilterData_0x1956_FindReadinessGroupIndexByReadinessGroup(ReadinessGroup, &lFilterDataPtr->TableIndex.ReadinessGroupIdx);  /* SBSW_DEM_POINTER_FILTERDATA_STRUCT_MEMBER_ARGUMENT */
  Dem_FilterData_0x1956_ReadinessGroupToEventTableIter_Init(lFilterDataPtr->TableIndex.ReadinessGroupIdx,                        /* SBSW_DEM_POINTER_FILTERDATA_STRUCT_MEMBER_ARGUMENT */

 ...
 *  \details    Type definitions of Memory EntryIF subcomponent which encapsulates the Memory entry and known data stored
 *              in the memory entry
 *********************************************************************************************************************/
...
#define DEM_MEMORYENTRY_HANDLE_READOUTBUFFER    DEM_CFG_MEMORYENTRY_HANDLE_READOUTBUFFER                        /*!< Value for the first readout buffer memory entry handle */

 ...
 *****************************************************************************/
/*!
 * \brief         Retrieves the first record number of the event's normal rate 
 *                time series snapshot.
 *
 * \details       Retrieves the first record number of the event's normal rate 
 *                time series snapshot.
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 *
 * \return        The first record number of the event's normal rate time series 
 *                snapshot.
 *
 * \pre           -
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Retrieves the last record number of the event's normal rate 
 *                time series snapshot.
 *
 * \details       Retrieves the last record number of the event's normal rate 
 *                time series snapshot.
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 *
 * \return        The last record number of the event's normal rate time series 
 *                snapshot.
 *
 * \pre           -
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Retrieves the first record number of the event's fast rate
 *                time series snapshot
 *
 * \details       Retrieves the first record number of the event's fast rate
 *                time series snapshot
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 *
 * \return        The first record number of the event's fast rate time series
 *                snapshot
 *
 * \pre           -
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Retrieves the last record number of the event's fast rate time
 *                series snapshot
 *
 * \details       Retrieves the last record number of the event's fast rate time
 *                series snapshot
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 *
 * \return        The last record number of the event's fast rate time series
 *                snapshot
 *
 * \pre           -
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Retrieves the first record number of the event's time 
 *                series snapshot.
 *
 * \details       Retrieves the first record number of the event's time 
 *                series snapshot.
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 *
 * \return        The first record number of the event's time series snapshot.
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *****************************************************************************/
/*!
 * \brief         Retrieves the last record number of the event's time series 
 *                snapshot.
 *
 * \details       Retrieves the last record number of the event's time series 
 *                snapshot.
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 *
 * \return        The last record number of the event's time series snapshot.
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *****************************************************************************/
/*!
 * \brief         Test if the record number belongs to the event's normal rate 
 *                time series.
 *
 * \details       Test if the record number belongs to the event's normal rate
 *                time series.
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 ...
 *
 * \return        TRUE
 *                The record number belongs to the event's normal rate time 
 *                series.
 * \return        TRUE
 *                The record number does not belong to the event's normal rate 
 *                time series.
 *
 * \pre           -
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Test if the record number belongs to the event's fast rate 
 *                time series.
 *
 * \details       Test if the record number belongs to the event's fast rate 
 *                time series.
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 ...
 *
 * \return        TRUE
 *                The record number belongs to the event's fast rate time series.
 * \return        TRUE
 *                The record number does not belong to the event's fast rate time 
 *                series.
 *
 * \pre           -
 *
...
* \return        FALSE
*                The event does not store a normal rate time series record.
*
* \pre           -
*
* \context       TASK|ISR2
...
* \return        FALSE
*                The event does not store a fast rate time series record
*
* \pre           -
*
* \context       TASK|ISR2

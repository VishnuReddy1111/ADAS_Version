...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_RT_Vishnu_SG_BMC_HV_17_SG_BMC_HV_10(P2CONST(SG_BMC_HV_14, AUTOMATIC, RTE_RT_VISHNU_APPL_DATA) data); /* PRQA S 0786, 3449, 0624 */ /* MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_RT_Vishnu_ClearDTC_DemClient_DCM_ClearDTC(void); /* PRQA S 0786, 3449, 0624 */ /* MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_RT_Vishnu_ClearDTC_DemClient_DCM_SelectDTC(uint32 DTC, Dem_DTCFormatType DTCFormat, Dem_DTCOriginType DTCOrigin); /* PRQA S 0786, 3449, 0624 */ /* MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
...
#  define Rte_Write_SG_BMC_HV_17_SG_BMC_HV_10 Rte_Write_RT_Vishnu_SG_BMC_HV_17_SG_BMC_HV_10
...
FUNC(Std_ReturnType, RTE_DEMMASTER_0_APPL_CODE) Dem_GetDTCSuppression(uint8 parg0, P2VAR(boolean, AUTOMATIC, RTE_DEMMASTER_0_APPL_VAR) SuppressionStatus); /* PRQA S 0786, 3449, 0624 */ /* MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
FUNC(Std_ReturnType, RTE_DEMMASTER_0_APPL_CODE) Dem_SetDTCSuppression(uint8 parg0, boolean SuppressionStatus); /* PRQA S 0786, 3449, 0624 */ /* MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
...
#  define Rte_Call_ClearDTC_DemClient_DCM_ClearDTC Rte_Call_RT_Vishnu_ClearDTC_DemClient_DCM_ClearDTC
#  define Rte_Call_ClearDTC_DemClient_DCM_SelectDTC Rte_Call_RT_Vishnu_ClearDTC_DemClient_DCM_SelectDTC
#  define Rte_Call_ControlDTCSuppression_DemClient_DCM_GetDTCSuppression(arg1) (Dem_GetDTCSuppression((uint8)0, arg1))
#  define Rte_Call_ControlDTCSuppression_DemClient_DCM_SetDTCSuppression(arg1) (Dem_SetDTCSuppression((uint8)0, arg1))
...
#  define Rte_Call_Event_DTC_0xd12000_GetDTCOfEvent(arg1, arg2) (Dem_GetDTCOfEvent((Dem_EventIdType)76, arg1, arg2))
#  define Rte_Call_Event_DTC_0xd12000_GetEventExtendedDataRecordEx(arg1, arg2, arg3) (Dem_GetEventExtendedDataRecordEx((Dem_EventIdType)76, arg1, arg2, arg3))
#  define Rte_Call_Event_DTC_0xd12000_GetEventStatus(arg1) (Dem_GetEventUdsStatus((Dem_EventIdType)76, arg1))
...
#  define Rte_Call_Event_DTC_0xd12101_SetEventStatus(arg1) (Dem_SetEventStatus((Dem_EventIdType)83, arg1))

 ...
 *****************************************************************************/
/*!
 * \brief         Tests whether the MemoryIndex belonging to the Memory stores the
 *                input event.
 *
 * \details       Tests whether the MemoryIndex belonging to the Memory stores the
 *                input event.
 *
 * \param[in]     TranslatedMemoryId
 *                Translated Memory Identifier of the event memory.
 ...
 *****************************************************************************/
/*!
 * \brief         Update the event memory entry chronology.
 *
 * \details       Update the event memory entry chronology.
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 ...
 *
 * \details       Ensure existing permanent entries of B1 DTCs are in state 'Active'
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Memory_UpdatePermanentMemoryOnEnteringActivationMode4(void);
 ...
 *
 * \details       Mark permanent entry of event VISIBLE if OBDII/OBDonUDS and immediate 

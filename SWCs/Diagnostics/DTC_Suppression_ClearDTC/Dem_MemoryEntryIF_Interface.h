...
/* ****************************************************************************
 * Dem_MemoryEntry_MemoryEntryIF_GetSnapshotHeaderFifo
 *****************************************************************************/
/*!
 * \brief         Get the Fifo snapshot header of the memory entry
 *
 * \details       Get the Fifo snapshot header of the memory entry
 *
 * \param[in]     MemoryEntryId
 *                The memory entry handle
 *
 * \return        The Fifo snapshot header of the memory entry
 *
 * \pre           -
 *
 * \context       TASK|ISR2
...
/* ****************************************************************************
 * Dem_MemoryEntry_MemoryEntryIF_SetSnapshotHeaderFifo
 *****************************************************************************/
/*!
 * \brief         Set the Fifo snapshot header in the memory entry
 *
 * \details       Set the Fifo snapshot header in the memory entry
 *
 * \param[in]     MemoryEntryId
 *                The memory entry handle
 * \param[in]     SnapshotHeaderFifo
 *                The Fifo snapshot header to be set in the memory entry
 *
 * \pre           -
 *
 * \context       TASK|ISR2

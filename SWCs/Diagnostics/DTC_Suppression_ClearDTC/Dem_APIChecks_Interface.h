 ...
 *
 * \details       Checks whether any OBD version is supported in the current variant.
...
/* ****************************************************************************
 * Dem_APIChecks_IsDTCFormatUDS
 *****************************************************************************/
/*!
 * \brief         Check whether the DTC format is UDS DTC format.
 *
 * \details       Check whether the DTC format is UDS DTC format.
 *
 * \param[in]     DTCFormat
 *                The requested DTC format
 *
 * \return        TRUE
 *                The DTC format is UDS DTC format
 * \return        FALSE
 *                The DTC format is not UDS DTC format
 *
 * \pre           -
 * \context       TASK|ISR2
 * \synchronous   TRUE

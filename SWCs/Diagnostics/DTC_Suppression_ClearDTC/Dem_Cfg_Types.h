...
#define DEM_CFG_DATA_FROM_WUC_SINCE_LAST_FAILED                                (36U)  /*!< Data element maps to the number of WUC since last failed (1 byte) */
#define DEM_CFG_DATA_FROM_SI30_STATUS                                          (37U)  /*!< Data element maps to the Status Indicator byte */
#define DEM_CFG_DATA_FROM_IUMPR                                                (38U)  /*!< Data element maps to worst ratio (Numerator and Denominator) of a DTC */
#define DEM_CFG_DATA_FROM_DTR                                                  (39U)  /*!< Data element maps to all DTRs of an event (group) */
#define DEM_CFG_DATA_FROM_MONITOR_ACTIVITY_DATA                                (40U)  /*!< Data element maps to the worst MAN and SMAR of a DTC */
#define DEM_CFG_DATAELEMENT_INVALID                                            (41U)  /*!< Data element does not map to data */

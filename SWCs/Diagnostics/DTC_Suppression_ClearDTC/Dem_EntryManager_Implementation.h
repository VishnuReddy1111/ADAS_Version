...
# if (DEM_CFG_SUPPORT_TIME_SERIES_POWERTRAIN == STD_OFF)
  Entry->UnusedFutureSamples_NormalRate = UnusedFutureSamples;                                                                   /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
# endif
...
# if (DEM_CFG_SUPPORT_TIME_SERIES_POWERTRAIN == STD_OFF)
#  if (DEM_CFG_SUPPORT_TIME_SERIES_FUTURE_FAST == STD_ON)
  Entry->UnusedFutureSamples_FastRate = UnusedFutureSamples;                                                                     /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
#  endif
# endif
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(Entry)                                                                                        /* PRQA S 1338, 3112 */ /* MD_MSR_DummyStmt, MD_DEM_14.2 */ 
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(UnusedFutureSamples)                                                                          /* PRQA S 1338, 3112 */ /* MD_MSR_DummyStmt, MD_DEM_14.2 */ 
...
{
  return EntryCompanion->MissingFutureNormalSample;                                                                             /* PRQA S 2842, 2843 */ /* MD_DEM_Dir4.1_ReadOperation, MD_DEM_Dir4.1_ReadOperation */
}
#endif
...
{
  return EntryCompanion->MissingFutureFastSample;                                                                               /* PRQA S 2842, 2843 */ /* MD_DEM_Dir4.1_ReadOperation, MD_DEM_Dir4.1_ReadOperation */
}
#endif
...
)
{
  ...
  Entry->Td = TimeSinceLastSample;                                                                                               /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
#else
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(Entry)                                                                                        /* PRQA S 1338, 3112 */ /* MD_MSR_DummyStmt, MD_DEM_14.2 */ 
...
{
# if (DEM_CFG_SUPPORT_TIME_SERIES_POWERTRAIN == STD_ON)
  Entry->UnusedPastSamples = UnusedPastSamples;                                                                                  /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
#else
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(Entry)                                                                                        /* PRQA S 1338, 3112 */ /* MD_MSR_DummyStmt, MD_DEM_14.2 */ 
...
# if (DEM_CFG_SUPPORT_TIME_SERIES_POWERTRAIN == STD_ON)
  Entry->UnusedPastSamples = UnusedPastSamples;                                                                                  /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
# else
  Entry->UnusedPastSamples_NormalRate = UnusedPastSamples;                                                                       /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
# endif
}
#endif
...
#  if (DEM_CFG_SUPPORT_TIME_SERIES_PAST_FAST == STD_ON)
  Entry->UnusedPastSamples_FastRate = UnusedPastSamples;                                                                         /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
#  endif
# endif
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(Entry)                                                                                        /* PRQA S 1338, 3112 */ /* MD_MSR_DummyStmt, MD_DEM_14.2 */ 
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(UnusedPastSamples)                                                                            /* PRQA S 1338, 3112 */ /* MD_MSR_DummyStmt, MD_DEM_14.2 */ 
...
# endif
       ...
       Dem_Memory_TimeSeries_EntryManager_EventDidIterNext(&lDidIter))                                                           /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    ...
    if (Dem_Data_CheckAvailableSizeDestinationBuffer(&lDestinationBuffer, lDidSize) == E_OK)                                     /* SBSW_DEM_POINTER_FORWARD_STACK */
    {
      Dem_SharedDataPtrType lDestinationBufferWritePtr = Dem_Data_GetPtrToWriteIndexOfDestinationBuffer(&lDestinationBuffer);    /* SBSW_DEM_POINTER_FORWARD_STACK */

      Dem_MemCpy(lDestinationBufferWritePtr,                                                                                     /* PRQA S 0311, 0315, 0602 */ /* MD_DEM_11.8, MD_MSR_VStdLibCopy, MD_DEM_20.2 */ /* SBSW_DEM_WRITE_DESTINATIONBUFFER */
        (Dem_DataPtrType)&lSourceBuffer[Dem_Cfg_DidBufferIndexNormal(lDidIndex)],
        lDidSize);

      Dem_Data_IncrementWriteIndexDestinationBuffer(&lDestinationBuffer, lDidSize);                                              /* SBSW_DEM_POINTER_FORWARD_STACK */
    }
  }
...
# endif
       ...
       Dem_Memory_TimeSeries_EntryManager_EventDidIterNext(&lDidIter))                                                           /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    ...
    if (Dem_Data_CheckAvailableSizeDestinationBuffer(&lDestinationBuffer, lDidSize) == E_OK)                                     /* SBSW_DEM_POINTER_FORWARD_STACK */
    {
      ...
      Dem_MemCpy(lDestinationBufferWritePtr,                                                                                     /* PRQA S 0311, 0315, 0602 */ /* MD_DEM_11.8, MD_MSR_VStdLibCopy, MD_DEM_20.2 */ /* SBSW_DEM_WRITE_DESTINATIONBUFFER */
        (Dem_DataPtrType)&lSourceBuffer[Dem_Cfg_DidBufferIndexFast(lDidIndex)],
        lDidSize);
...
{
  EntryCompanion->MissingFutureNormalSample = Value;                                                                             /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
}
#endif
...
{
  EntryCompanion->MissingFutureFastSample = Value;                                                                               /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
}
#endif
  ...
  )
{
  ...
  Dem_Memory_TimeSeries_EntryManager_SetUnusedPastSamplesNormal(TimeSeriesEntry, Dem_Cfg_TimeSeriesPastSamplesNormal());         /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  Dem_Memory_TimeSeries_EntryManager_SetUnusedFutureSamplesNormal(TimeSeriesEntry, Dem_Cfg_TimeSeriesFutureSamplesNormal());     /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  Dem_Memory_TimeSeries_EntryManager_SetUnusedPastSamplesFast(TimeSeriesEntry, Dem_Cfg_TimeSeriesPastSamplesFast());             /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  Dem_Memory_TimeSeries_EntryManager_SetUnusedFutureSamplesFast(TimeSeriesEntry, Dem_Cfg_TimeSeriesFutureSamplesFast());         /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  Dem_Memory_TimeSeries_EntryManager_SetUnusedPastSamples(TimeSeriesEntry,
                     DEM_MEMORY_TIMESERIES_ENTRYMANAGER_UNUSEDSAMPLES_INITVALUE);                                                /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
}                                                                                                                                /* PRQA S 6050 */ /* MD_MSR_STCAL */
#endif
...
# if DEM_CFG_SUPPORT_TIME_SERIES_FUTURE_FAST == STD_ON
    Dem_Memory_TimeSeries_EntryManager_SetMissingFastSamples(TimeSeriesEntryCompanion, 0u);                                      /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
# endif
# if DEM_CFG_SUPPORT_TIME_SERIES_FUTURE_NORMAL == STD_ON
      Dem_Memory_TimeSeries_EntryManager_SetMissingNormalSamples(TimeSeriesEntryCompanion, 0u);                                  /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
# endif
}
#endif
  ...
  )
{
  ...
  lEntry = Dem_Memory_TimeSeries_GetEntryPtrSafe(MemoryIndex);

# if (DEM_CFG_SUPPORT_TIME_SERIES_PAST_NORMAL == STD_ON)
  if(Dem_Memory_TimeSeries_TestEventSupportNormalRate(EventId) == TRUE)
  {
    uint8 lSourceSample;
...
#  endif
    ...
    for (lSourceSample = 0u; lSourceSample < lNumberStoredSamples; ++lSourceSample)
    {
      ...
      Dem_Memory_TimeSeries_EntryManager_CopyNormalDidsFromRingBuffer(                                                           /* SBSW_DEM_POINTER_TIMESERIESENTRY_NORMALBUFFER */
        EventId,
        lSourceSample,
        Dem_Memory_TimeSeries_EntryManager_GetNormalDataPtr(lEntry, lTargetSample),                                              /* SBSW_DEM_POINTER_TIMESERIESENTRY_NORMALBUFFER */
        Dem_Memory_TimeSeries_EntryManager_GetRecMaxRawSize()
        );
    }
...
#  endif
    ...
    for (lSourceSample = 0u; lSourceSample < lNumberStoredSamples; ++lSourceSample)
    {
      ...
      Dem_Memory_TimeSeries_EntryManager_CopyFastDidsFromRingBuffer(                                                             /* SBSW_DEM_POINTER_TIMESERIESENTRY_FASTBUFFER */
        EventId,
        lSourceSample,
        Dem_Memory_TimeSeries_EntryManager_GetFastDataPtr(lEntry, lTargetSample),                                                /* SBSW_DEM_POINTER_TIMESERIESENTRY_FASTBUFFER */
        Dem_Memory_TimeSeries_EntryManager_GetRecMaxRawSize()
        );
    }
...
)
{
  ...
  if (Value > 0.0f)
  {
    if (Value < (float32)DEM_MEMORY_TIMESERIES_UINT16_MAXVALUE)
    {
    ...
    {
      lConvertedValue = DEM_MEMORY_TIMESERIES_UINT16_MAXVALUE;
    }
  }

...
)
{
  ...
  return (boolean)(Dem_Memory_TimeSeries_EntryManager_GetReadoutState(lEntryCompanion)                                           /* SBSW_DEM_POINTER_READ_TIMESERIESENTRYCOMPANION */
...
)
{
  ...
  Dem_Mem_ConstTimeSeriesEntryCompanionPtrType lTimeSeriesEntryCompanion;
  Dem_Memory_TimeSeries_EntryManager_ReadoutStatusType lReadoutStatus;

  lTimeSeriesEntryCompanion = Dem_Memory_TimeSeries_GetEntryCompanionSafe(MemoryIndex);
  lReadoutStatus = Dem_Memory_TimeSeries_EntryManager_GetReadoutState(lTimeSeriesEntryCompanion);                                /* SBSW_DEM_POINTER_READ_TIMESERIESENTRYCOMPANION */
  lClientCounter = Dem_Memory_TimeSeries_EntryManager_GetClientCounter(lTimeSeriesEntryCompanion);                               /* SBSW_DEM_POINTER_READ_TIMESERIESENTRYCOMPANION */
...
{
  return (boolean)(Dem_Memory_TimeSeries_TestEventSupportNormalRate(EventId) ||  Dem_Memory_TimeSeries_TestEventSupportFastRate(EventId));
}


/* ****************************************************************************
 % Dem_Memory_TimeSeries_GetFirstNormalRateRecordNumber
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
#if (DEM_FEATURE_NEED_TIME_SERIES_NORMAL == STD_ON)
  if (Dem_Cfg_IsTimeSeriesFreezeFrameTableNormalRateUsedOfEventTable(EventId)== TRUE)
  {
    lRecordNr = (uint8)Dem_Cfg_GetFirstRecordNumberOfTimeSeriesFreezeFrameTable(Dem_Cfg_GetTimeSeriesFreezeFrameTableNormalRateIdxOfEventTable(EventId));
  }
  else
#endif
  {
    lRecordNr = DEM_MEMORY_TIMESERIES_INVALID_SREC_ID;
...
/* ****************************************************************************
 % Dem_Memory_TimeSeries_GetLastNormalRateRecordNumber
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
  ...
  )
{
  ...
  if (Dem_Cfg_IsTimeSeriesFreezeFrameTableNormalRateUsedOfEventTable(EventId)== TRUE)
  {
    lRecordNr = (uint8)Dem_Cfg_GetLastRecordNumberOfTimeSeriesFreezeFrameTable(Dem_Cfg_GetTimeSeriesFreezeFrameTableNormalRateIdxOfEventTable(EventId));
  }
  else
#endif
  {
...
/* ****************************************************************************
 % Dem_Memory_TimeSeries_GetFirstFastRateRecordNumber
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
)
{
  ...
  if (Dem_Cfg_IsTimeSeriesFreezeFrameTableFastRateUsedOfEventTable(EventId) == TRUE)
  {
    lRecordNr = (uint8)Dem_Cfg_GetFirstRecordNumberOfTimeSeriesFreezeFrameTable(Dem_Cfg_GetTimeSeriesFreezeFrameTableFastRateIdxOfEventTable(EventId));
  }
  else
#endif
  {
...
/* ****************************************************************************
 % Dem_Memory_TimeSeries_GetLastFastRateRecordNumber
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
  ...
  )
{
  ...
  if(Dem_Cfg_IsTimeSeriesFreezeFrameTableFastRateUsedOfEventTable(EventId)== TRUE)
  {
    lRecordNr = (uint8)Dem_Cfg_GetLastRecordNumberOfTimeSeriesFreezeFrameTable(Dem_Cfg_GetTimeSeriesFreezeFrameTableFastRateIdxOfEventTable(EventId));
  }
  else
#endif
  {
...
/* ****************************************************************************
 % Dem_Memory_TimeSeries_GetFirstSRecNumber
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
Dem_Memory_TimeSeries_GetFirstSRecNumber(                                                                                        /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  Dem_EventIdType  EventId
  )
{
  uint8 lFirstRecordNr = Dem_Memory_TimeSeries_GetFirstNormalRateRecordNumber(EventId);
  uint8 lFirstFastRateRecordNr = Dem_Memory_TimeSeries_GetFirstFastRateRecordNumber(EventId);

  if (lFirstFastRateRecordNr != DEM_MEMORY_TIMESERIES_INVALID_SREC_ID)
  {
    if ((lFirstRecordNr == DEM_MEMORY_TIMESERIES_INVALID_SREC_ID) || (lFirstFastRateRecordNr < lFirstRecordNr))
    {
      lFirstRecordNr = lFirstFastRateRecordNr;
    }
  }

  return lFirstRecordNr;
}


/* ****************************************************************************
 % Dem_Memory_TimeSeries_GetLastSRecNumber
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL FUNC(uint8, DEM_CODE)
Dem_Memory_TimeSeries_GetLastSRecNumber(                                                                                         /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  Dem_EventIdType  EventId
  )
{
  uint8 lLastRecordNr;
  uint8 lLastNormalRateRecordNr = Dem_Memory_TimeSeries_GetLastNormalRateRecordNumber(EventId);
  uint8 lLastFastRateRecordNr = Dem_Memory_TimeSeries_GetLastFastRateRecordNumber(EventId);

  lLastRecordNr = (lLastNormalRateRecordNr > lLastFastRateRecordNr) ? lLastNormalRateRecordNr : lLastFastRateRecordNr;           /* PRQA S 2998 */ /* MD_DEM_2998 */ 

  return lLastRecordNr;
}


/* ****************************************************************************
 % Dem_Memory_TimeSeries_TestRecordNumberIsNormalRate
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
Dem_Memory_TimeSeries_TestRecordNumberIsNormalRate(                                                                              /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_EventIdType  EventId,                                                                                                      /* PRQA S 3206 */ /* MD_DEM_3206 */
  uint8 RecordNumber
)
{
  ...
  if (Dem_Memory_TimeSeries_TestEventSupportNormalRate(EventId)
     && (RecordNumber >= Dem_Memory_TimeSeries_GetFirstNormalRateRecordNumber(EventId))
     && (RecordNumber <= Dem_Memory_TimeSeries_GetLastNormalRateRecordNumber(EventId)))
  {
    lReturn = TRUE;
  }
  else
...
/* ****************************************************************************
 % Dem_Memory_TimeSeries_TestRecordNumberIsFastRate
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL FUNC(boolean, DEM_CODE)
Dem_Memory_TimeSeries_TestRecordNumberIsFastRate(                                                                                /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_EventIdType  EventId,                                                                                                      /* PRQA S 3206 */ /* MD_DEM_3206 */
  uint8 RecordNumber
)
{
  ...
  if (Dem_Memory_TimeSeries_TestEventSupportFastRate(EventId)
    && (RecordNumber >= Dem_Memory_TimeSeries_GetFirstFastRateRecordNumber(EventId))
    && (RecordNumber <= Dem_Memory_TimeSeries_GetLastFastRateRecordNumber(EventId)))
  {
    lReturn = TRUE;
  }
  else
...
/* ****************************************************************************
 % Dem_Memory_TimeSeries_TestRecordNumberIsValid
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL FUNC(boolean, DEM_CODE)
Dem_Memory_TimeSeries_TestRecordNumberIsValid(                                                                                   /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  Dem_EventIdType  EventId,
  uint8  RecordNumber
  )
{
  return (Dem_Memory_TimeSeries_TestRecordNumberIsNormalRate(EventId, RecordNumber) || Dem_Memory_TimeSeries_TestRecordNumberIsFastRate(EventId, RecordNumber));
}
...
)
{
  Dem_Memory_TimeSeries_EntryManager_ReadoutStatusType lReadoutStatus;
  lReadoutStatus = 
    Dem_Memory_TimeSeries_EntryManager_GetReadoutState(Dem_Memory_TimeSeries_GetEntryCompanionSafe(MemoryIndex));                /* SBSW_DEM_POINTER_READ_TIMESERIESENTRYCOMPANION */
...
{
#if (DEM_FEATURE_NEED_TIME_SERIES == STD_ON)
  Dem_MemAccess_MemoryFreeIndex(DEM_CFG_MEMORYID_TIMESERIES, TimeSeriesIndex);
#else
...
{
#if (DEM_FEATURE_NEED_TIME_SERIES == STD_ON)
  uint8 lTimeSeriesMaxSize;
  boolean lLowerBoundOk;
  boolean lUpperBoundOk;
  Dem_Cfg_MemoryIndexType lTimeSeriesStartIndex;

  lTimeSeriesMaxSize = Dem_MemState_MemoryGetMaxSize(DEM_CFG_MEMORYID_TIMESERIES);
  lTimeSeriesStartIndex = Dem_MemState_MemoryGetFirstIndex(DEM_CFG_MEMORYID_TIMESERIES);
  lLowerBoundOk = (lTimeSeriesStartIndex <= MemoryIndex);
  lUpperBoundOk = ((lTimeSeriesStartIndex + lTimeSeriesMaxSize) > MemoryIndex);
  ...
  )
{
  ...
  if (Dem_MemState_MemoryGetMaxSize(DEM_CFG_MEMORYID_TIMESERIES) == Dem_MemState_MemoryGetCurrentSize(DEM_CFG_MEMORYID_TIMESERIES))
  { /* Memory is filled up */
    lMemoryIndex = Dem_MemAccess_SelectDisplacedIndex(DEM_CFG_MEMORYID_TIMESERIES, EventId);
    ...
    { /* a displaced DTC was identified, now remove that DTC */
      ...
      lDisplacedEventId = Dem_Memory_TimeSeries_GetEntryPtrSafe(lMemoryIndex)->EventId;
  ...
  if (lMemoryIndex != DEM_MEM_INVALID_MEMORY_INDEX)
  {
    ...
    lEntry = Dem_Memory_TimeSeries_GetEntryPtrSafe(lMemoryIndex);
    lEntryCompanion = Dem_Memory_TimeSeries_GetEntryCompanionSafe(lMemoryIndex);
    lMemorySize = Dem_MemState_MemoryGetCurrentSize(DEM_CFG_MEMORYID_TIMESERIES);

    /* fill the chrono record with event id and lock the referenced time series slot */
    Dem_MemState_MemorySetChronology(DEM_CFG_MEMORYID_TIMESERIES, lMemorySize, lMemoryIndex);

    lEntry->EventId = lMasterEventId;                                                                                            /* SBSW_DEM_POINTER_WRITE_TIMESERIESENTRY */
    lEntry->Timestamp = Dem_MemState_GetCurrentTimestamp();                                                                      /* SBSW_DEM_POINTER_WRITE_TIMESERIESENTRY */
    ...
    Dem_MemState_MemorySetCurrentSize(DEM_CFG_MEMORYID_TIMESERIES, (uint8)(lMemorySize + 1u));
  }
  return lMemoryIndex;
#else
...
#if (DEM_FEATURE_NEED_TIME_SERIES == STD_ON)
/* ****************************************************************************
 % Dem_Memory_TimeSeries_GetEntryPtrSafe
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if (Dem_Memory_TimeSeries_TestIndexIsTimeSeriesEntry(MemoryIndex) == FALSE)
  {
    Dem_Cfg_MemoryIndexType lTimeSeriesStartIndex;
    lTimeSeriesStartIndex = Dem_MemState_MemoryGetFirstIndex(DEM_CFG_MEMORYID_TIMESERIES);
    lReturnValue = (Dem_Mem_TimeSeriesEntryPtrType)Dem_Cfg_MemoryDataPtr[lTimeSeriesStartIndex];                                 /* PRQA S 0310, 3305 */ /* MD_DEM_11.4_nvm, MD_DEM_3305 */
 ...
 *
*/
DEM_LOCAL FUNC(Dem_Mem_TimeSeriesEntryCompanionPtrType, DEM_CODE)
Dem_Memory_TimeSeries_GetEntryCompanionSafe(
  Dem_Cfg_MemoryIndexType  MemoryIndex
)
{
  Dem_Cfg_TimeSeriesEntryCompanionType* lReturnValue;
  Dem_Cfg_MemoryIndexType lEntryCompanionIndex;
  lEntryCompanionIndex = MemoryIndex - Dem_MemState_MemoryGetFirstIndex(DEM_CFG_MEMORYID_TIMESERIES);

# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if (lEntryCompanionIndex >= Dem_MemState_MemoryGetMaxSize(DEM_CFG_MEMORYID_TIMESERIES))
  {
    Dem_Error_RunTimeCheckFailed(DEM_TIMESERIESIF_IMPLEMENTATION_FILENAME, __LINE__);                                            /* SBSW_DEM_POINTER_RUNTIME_CHECK */
...
/* ****************************************************************************
 % Dem_Memory_TimeSeries_TestEventSupportNormalRate
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Memory_TimeSeries_TestEventSupportNormalRate(                                                                                /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_EventIdType  EventId                                                                                                       /* PRQA S 3206 */ /* MD_DEM_3206 */
  )
{
#if (DEM_FEATURE_NEED_TIME_SERIES_NORMAL == STD_ON)
  return (boolean)(Dem_Cfg_IsTimeSeriesFreezeFrameTableNormalRateUsedOfEventTable(EventId));
#else
  DEM_IGNORE_UNUSED_ARGUMENT(EventId)                                                                                           /* PRQA S 1338, 3112 */ /* MD_MSR_DummyStmt, MD_DEM_14.2 */
  return FALSE;
#endif
...
/* ****************************************************************************
 % Dem_Memory_TimeSeries_TestEventSupportFastRate
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Memory_TimeSeries_TestEventSupportFastRate(                                                                                  /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_EventIdType EventId                                                                                                        /* PRQA S 3206 */ /* MD_DEM_3206 */
  )
{
#if (DEM_FEATURE_NEED_TIME_SERIES_FAST == STD_ON)
  return (boolean)(Dem_Cfg_IsTimeSeriesFreezeFrameTableFastRateUsedOfEventTable(EventId));
#else
  DEM_IGNORE_UNUSED_ARGUMENT(EventId)                                                                                            /* PRQA S 1338, 3112 */ /* MD_MSR_DummyStmt, MD_DEM_14.2 */
  return FALSE;
#endif
...
# if (DEM_CFG_SUPPORT_TIME_SERIES_FUTURE_NORMAL == STD_ON)
       ...
       Dem_Memory_MemEntry_IterNext(&lTimeSeriesEntryIter))                                                                      /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    ...
    if ( (lEntry->EventId != DEM_EVENT_INVALID)
      ...
      && (Dem_Memory_TimeSeries_TestEventSupportNormalRate(lEntry->EventId) == TRUE))
    {
      Dem_Memory_TimeSeries_EntryManager_StoreNormalFutureSamples(lMemoryIndex, lEntry, lEntryCompanion);                        /* SBSW_DEM_POINTER_WRITE_TIMESERIESENTRY */ /* SBSW_DEM_POINTER_WRITE_TIMESERIESENTRYCOMPANION */
    }
  }
# endif
}                                                                                                                                /* PRQA S 6050 */ /* MD_MSR_STCAL */
...
# if (DEM_CFG_SUPPORT_TIME_SERIES_FUTURE_FAST == STD_ON)
       ...
       Dem_Memory_MemEntry_IterNext(&lTimeSeriesEntryIter))                                                                      /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    ...
    if ( (lEntry->EventId != DEM_EVENT_INVALID)
      && (Dem_Memory_TimeSeries_TestEntryAvailable(lMemoryIndex) == TRUE) 
      && (Dem_Memory_TimeSeries_TestEventSupportFastRate(lEntry->EventId) == TRUE) )
    {
      Dem_Memory_TimeSeries_EntryManager_StoreFastFutureSamples(lMemoryIndex, lEntry, lEntryCompanion);                          /* SBSW_DEM_POINTER_WRITE_TIMESERIESENTRY */ /* SBSW_DEM_POINTER_WRITE_TIMESERIESENTRYCOMPANION */
    }
  }
# endif
}                                                                                                                                /* PRQA S 6050 */ /* MD_MSR_STCAL */
  ...
  )
{
  ...
  lEventId = Dem_Memory_TimeSeries_GetEntryPtrSafe(Index)->EventId; 
  lEntryAvailable = Dem_Memory_TimeSeries_TestEntryAvailable(Index);
...
{
  Dem_Mem_TimeSeriesEntryCompanionPtrType lTimeSeriesEntryCompanionPtr;
  Dem_Mem_TimeSeriesEntryPtrType lTimeSeriesEntryPtr;

  lTimeSeriesEntryPtr = Dem_Memory_TimeSeries_GetEntryPtrSafe(Index);
  lTimeSeriesEntryCompanionPtr = Dem_Memory_TimeSeries_GetEntryCompanionSafe(Index);

  lTimeSeriesEntryPtr->EventId = DEM_EVENT_INVALID;                                                                              /* SBSW_DEM_POINTER_WRITE_TIMESERIESENTRY */
  lTimeSeriesEntryPtr->Timestamp = 0;                                                                                            /* SBSW_DEM_POINTER_WRITE_TIMESERIESENTRY */
...
/* No critical section needed for setting readout state and client counter since this entry-to-free function is unreachable for external APIs (Dem_EnableDtcRecordupdate). */
  Dem_Memory_TimeSeries_EntryManager_SetReadoutState(lTimeSeriesEntryCompanionPtr, 
                                                                       DEM_MEMORY_TIMESERIES_ENTRYMANAGER_READOUTSTATUS_UNUSED); /* SBSW_DEM_POINTER_WRITE_TIMESERIESENTRYCOMPANION */
  Dem_Memory_TimeSeries_EntryManager_InitClientCounter(lTimeSeriesEntryCompanionPtr);                                            /* SBSW_DEM_POINTER_WRITE_TIMESERIESENTRYCOMPANION */
}
#endif
...
)
{
  ...
  Dem_MemState_MemorySetCurrentSize(DEM_CFG_MEMORYID_TIMESERIES, 0);
       ...
       Dem_Memory_MemEntry_IterNext(&lMemEntryIter))                                                                             /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    ...
    lEntry = Dem_Memory_TimeSeries_GetEntryPtrSafe(lMemoryIndex);
    Dem_MemCpy((Dem_NvDataPtrType)lEntry,                                                                                        /* PRQA S 0310, 0311, 0315, 0602 */ /* MD_DEM_11.4_cpy, MD_DEM_11.8, MD_MSR_VStdLibCopy, MD_DEM_20.2 */ /* SBSW_DEM_POINTER_MEMCPY_TIMESERIESENTRY */
...
)
{
  ...
  for (lTimeSeriesIndex = Dem_MemState_MemoryGetFirstIndex(DEM_CFG_MEMORYID_TIMESERIES); 
       lTimeSeriesIndex < Dem_MemState_MemoryGetEndIndex(DEM_CFG_MEMORYID_TIMESERIES);
       ++lTimeSeriesIndex)
  {
    Dem_EventIdType lEventId;

    lEventId = Dem_Memory_TimeSeries_GetEntryPtrSafe(lTimeSeriesIndex)->EventId;
...
# endif
        )
      {
        ...
        Dem_FaultMemory_Memory_FreeEntry(DEM_CFG_MEMORYID_TIMESERIES, lTimeSeriesIndex);
      ...
      lTimestamp = Dem_Memory_TimeSeries_GetEntryPtrSafe(lTimeSeriesIndex)->Timestamp;

      if (lOtherIndex != lTimeSeriesIndex)
      {
        /* Clear the older entry */
        if (lTimestamp > Dem_Memory_TimeSeries_GetEntryPtrSafe(lOtherIndex)->Timestamp)
        {
...
# endif
      ...
      lSortedIndex = Dem_MemState_MemoryGetCurrentSize(DEM_CFG_MEMORYID_TIMESERIES);
      while ( (lSortedIndex > 0u)
        && (Dem_Memory_TimeSeries_GetEntryPtrSafe(Dem_MemState_MemoryGetChronology(DEM_CFG_MEMORYID_TIMESERIES, lSortedIndex - 1u))->Timestamp > lTimestamp))       /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      {
        Dem_MemState_MemorySetChronology(DEM_CFG_MEMORYID_TIMESERIES,
          lSortedIndex,
          Dem_MemState_MemoryGetChronology(DEM_CFG_MEMORYID_TIMESERIES, lSortedIndex - 1u));
        --lSortedIndex;
      }

      Dem_MemState_MemorySetChronology(DEM_CFG_MEMORYID_TIMESERIES, lSortedIndex, lTimeSeriesIndex);

      /* Update the number of occupied memory entries */
      Dem_MemState_MemorySetCurrentSize(DEM_CFG_MEMORYID_TIMESERIES,
        (uint8)(Dem_MemState_MemoryGetCurrentSize(DEM_CFG_MEMORYID_TIMESERIES) + 1u));
    }
  }
...
#  endif
#  if (DEM_CFG_SUPPORT_TIME_SERIES_FUTURE_FAST == STD_ON)
        if (Dem_Memory_TimeSeries_TestEventSupportFastRate(EventId) == TRUE)
        {
...
/* ****************************************************************************
 % Dem_Memory_TimeSeries_TestSRecIsStored
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL FUNC(boolean, DEM_CODE)
Dem_Memory_TimeSeries_TestSRecIsStored(                                                                                          /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  Dem_Mem_ConstTimeSeriesEntryPtrType TimeSeriesEntry,
  uint8  RecordNumber
  )
{
  ...
  if (Dem_Memory_TimeSeries_TestRecordNumberIsNormalRate(TimeSeriesEntry->EventId, RecordNumber) == TRUE)
  {
    /* Normal Sample */
    lSRecStoredIndex = RecordNumber - Dem_Memory_TimeSeries_GetFirstNormalRateRecordNumber(TimeSeriesEntry->EventId);
  ...
  else if (Dem_Memory_TimeSeries_TestRecordNumberIsFastRate(TimeSeriesEntry->EventId, RecordNumber) == TRUE)
  {
    /* Fast Sample */
    lSRecStoredIndex = RecordNumber - Dem_Memory_TimeSeries_GetFirstFastRateRecordNumber(TimeSeriesEntry->EventId);

 ...
 *****************************************************************************/
/*!
 * \brief         Check if aging is supported for all DTCs
 *
 * \details       Check if aging is supported for all DTCs
 *
 * \return        TRUE if DEM_CFG_SUPPORT_AGING_FOR_ALL_DTCS == STD_ON
 *                FALSE if DEM_CFG_SUPPORT_AGING_FOR_ALL_DTCS == STD_OFF
 *
 * \pre           -
 *
 * \context       TASK

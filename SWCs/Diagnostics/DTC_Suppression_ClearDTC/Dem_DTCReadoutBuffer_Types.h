...
typedef enum
{
  ...
  Dem_DTCReadoutBuffer_SnapshotSource_TimeSeries_Fast,             /*!< Classic Time Series source for fast rate */
  Dem_DTCReadoutBuffer_SnapshotSource_TimeSeries_Normal,           /*!< Classic Time Series source for normal rate */

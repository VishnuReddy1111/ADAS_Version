...
/*! Define whether PID21 calculation is required */
# define DEM_FEATURE_NEED_PID21  STD_ON
#else
/*! Define whether PID21 calculation is required */
# define DEM_FEATURE_NEED_PID21  STD_OFF
#endif

#if (  (DEM_CFG_SUPPORT_PID31  == STD_ON) \
    || (DEM_CFG_SUPPORT_J1939_READINESS2 == STD_ON) )
/*! Define whether PID31 calculation is required */
# define DEM_FEATURE_NEED_PID31   STD_ON
#else
/*! Define whether PID31 calculation is required */
# define DEM_FEATURE_NEED_PID31  STD_OFF
#endif

#if (  (DEM_CFG_SUPPORT_PID4D  == STD_ON) \
    || (DEM_CFG_SUPPORT_J1939_READINESS2 == STD_ON) )
/*! Define whether PID4D calculation is required */
# define DEM_FEATURE_NEED_PID4D   STD_ON
#else
/*! Define whether PID4D calculation is required */
# define DEM_FEATURE_NEED_PID4D  STD_OFF
#endif

#if (  (DEM_CFG_SUPPORT_PID4E  == STD_ON) \
    || (DEM_CFG_SUPPORT_J1939_READINESS2 == STD_ON) )
/*! Define whether PID4E calculation is required */
# define DEM_FEATURE_NEED_PID4E   STD_ON
#else
/*! Define whether PID4E calculation is required */
# define DEM_FEATURE_NEED_PID4E  STD_OFF
#endif
...
# define DEM_FEATURE_NEED_MIL_GROUPS             STD_OFF
   ...
   && ( (DEM_FEATURE_NEED_PID21 == STD_ON) \
     || (DEM_FEATURE_NEED_PID31 == STD_ON) \
...
/*! Define whether normal rate time series snapshots are stored */
# define DEM_FEATURE_NEED_TIME_SERIES_NORMAL     STD_ON
#else
/*! Define whether normal rate time series snapshots are stored */
# define DEM_FEATURE_NEED_TIME_SERIES_NORMAL     STD_OFF
#endif
...
#endif
#if ( (DEM_FEATURE_NEED_TIME_SERIES_NORMAL == STD_ON) || (DEM_FEATURE_NEED_TIME_SERIES_FAST == STD_ON) )
...
#if (DEM_FEATURE_NEED_OBD == STD_ON)
# if (DEM_FEATURE_NEED_PID4D == STD_ON) || (DEM_FEATURE_NEED_PID4E == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON)
...
# define DEM_FEATURE_NEED_PID41_CALCULATION      STD_OFF
    ...
    && ((DEM_FEATURE_NEED_OBD == STD_ON) && (DEM_CFG_SUPPORT_PID01 == STD_ON)))

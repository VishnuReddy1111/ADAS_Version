 ...
 *****************************************************************************/
 /*!
 * \brief         Tests if event availability is supported.
 *
 * \details       Tests if event availability is supported.
 *
 * \return        TRUE
 *                Event availability is supported
 * \return        FALSE
 *                Event availability is not supported
 *
 * \pre           -
 *
 * \context       TASK|ISR2

...
FUNC(uint8, RTE_CODE) Rte_Mode_RT_Vishnu_currentMode_currentMode(void);
...
#  define Rte_Mode_currentMode_currentMode Rte_Mode_RT_Vishnu_currentMode_currentMode
...
#  define Rte_Call_Event_DTC_0x10000d_SetEventStatus(arg1) (Dem_SetEventStatus((Dem_EventIdType)12, arg1))
...
#  define Rte_Call_OpCycle_DemOperationRT_SetOperationCycleState(arg1) (Dem_SetOperationCycleState((uint8)0, arg1))
...
#  define RTE_RUNNABLE_DataServices_Data_TABROW_DebugDID_Read_ConditionCheckRead DataServices_Data_TABROW_DebugDID_Read_ConditionCheckRead
#  define RTE_RUNNABLE_DataServices_Data_TABROW_DebugDID_Read_ReadData DataServices_Data_TABROW_DebugDID_Read_ReadData
#  define RTE_RUNNABLE_DataServices_Data_TABROW_DebugDID_Read_WriteData DataServices_Data_TABROW_DebugDID_Read_WriteData
...
FUNC(Std_ReturnType, RT_Vishnu_CODE) CBReadData_Data_StandardDTCInformation_Param_OccurCount_ReadData(P2VAR(DataPrimitiveType_uint8, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) Data); /* PRQA S 0786, 3449, 0624 */ /* MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
...
# endif
FUNC(Std_ReturnType, RT_Vishnu_CODE) DataServices_Data_TABROW_DebugDID_Read_ConditionCheckRead(Dcm_OpStatusType OpStatus, P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) ErrorCode); /* PRQA S 0786, 3449, 0624 */ /* MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
# ifndef RTE_PTR2ARRAYTYPE_PASSING
FUNC(Std_ReturnType, RT_Vishnu_CODE) DataServices_Data_TABROW_DebugDID_Read_ReadData(Dcm_OpStatusType OpStatus, P2VAR(uint8, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) Data); /* PRQA S 0786, 3449, 0624 */ /* MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
# else
FUNC(Std_ReturnType, RT_Vishnu_CODE) DataServices_Data_TABROW_DebugDID_Read_ReadData(Dcm_OpStatusType OpStatus, P2VAR(Dcm_Data150ByteType, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) Data); /* PRQA S 0786, 3449, 0624 */ /* MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
# endif
# ifndef RTE_PTR2ARRAYTYPE_PASSING
FUNC(Std_ReturnType, RT_Vishnu_CODE) DataServices_Data_TABROW_DebugDID_Read_WriteData(P2CONST(uint8, AUTOMATIC, RTE_RT_VISHNU_APPL_DATA) Data, Dcm_OpStatusType OpStatus, P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) ErrorCode); /* PRQA S 0786, 3449, 0624 */ /* MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
# else
FUNC(Std_ReturnType, RT_Vishnu_CODE) DataServices_Data_TABROW_DebugDID_Read_WriteData(P2CONST(Dcm_Data150ByteType, AUTOMATIC, RTE_RT_VISHNU_APPL_DATA) Data, Dcm_OpStatusType OpStatus, P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) ErrorCode); /* PRQA S 0786, 3449, 0624 */ /* MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
# endif
...
#  define RTE_E_CSDataServices_Data_StandardDTCInformation_Param_OccurCount_E_NOT_OK (1U)
...
#  define RTE_E_DataServices_Data_TABROW_DebugDID_Read_DCM_E_PENDING (10U)

#  define RTE_E_DataServices_Data_TABROW_DebugDID_Read_E_NOT_OK (1U)

 ...
 *          License:  CBD2300382
 *
 *      Description:  Application types header file for SW-C <RT_Diag_SWC> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_RT_DIAG_SWC_TYPE_H
# define RTE_RT_DIAG_SWC_TYPE_H
...
# define RTE_MODE_RT_Diag_SWC_DcmDiagnosticSessionControl_DEFAULT_SESSION (1U)
...
# endif
# define RTE_MODE_RT_Diag_SWC_DcmDiagnosticSessionControl_PROGRAMMING_SESSION (2U)
...
# endif
# define RTE_MODE_RT_Diag_SWC_DcmDiagnosticSessionControl_EXTENDED_SESSION (3U)
...
# endif
# define RTE_TRANSITION_RT_Diag_SWC_DcmDiagnosticSessionControl (255U)

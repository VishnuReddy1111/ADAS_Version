 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  RT_Vishnu.c
 *           Config:  D:/SIPs/Backup/ADAS/02_EcuCfg/ADAS.dpa
 *        SW-C Type:  RT_Vishnu
 *  Generation Time:  2024-09-11 14:06:11
 *
 ...
 *      For example: 1, 0, 126, +10.
 *
 * Debug_Test_Frame_NewPDU_NewSignal1_57aeedf7a93f27a0
 *   uint8 represents integers with a minimum value of 0 and a maximum value of 255.
 *      The order-relation on uint8 is: x < y if y - x is positive.
 *      uint8 has a lexical representation consisting of a finite-length sequence 
 *      of decimal digits (#x30-#x39).
 ...
 *      For example: 1, 0, 126, +10.
 *
 * Debug_Test_Frame_NewPDU_NewSignal2_34f600a5e6e0092e
 *   uint8 represents integers with a minimum value of 0 and a maximum value of 255.
 *      The order-relation on uint8 is: x < y if y - x is positive.
 *      uint8 has a lexical representation consisting of a finite-length sequence 
 *      of decimal digits (#x30-#x39).
 ...
 *      For example: 1, 0, 126, +10.
 *
 * Debug_Test_Frame_NewPDU_NewSignal3_19e862b5444a2f34
 *   uint8 represents integers with a minimum value of 0 and a maximum value of 255.
 *      The order-relation on uint8 is: x < y if y - x is positive.
 *      uint8 has a lexical representation consisting of a finite-length sequence 
 *      of decimal digits (#x30-#x39).
 ...
 *      For example: 1, 0, 126, +10.
 *
 * Debug_Test_Frame_NewPDU_NewSignal4_19c96f83bd5c4a32
 *   uint8 represents integers with a minimum value of 0 and a maximum value of 255.
 *      The order-relation on uint8 is: x < y if y - x is positive.
 *      uint8 has a lexical representation consisting of a finite-length sequence 
 *      of decimal digits (#x30-#x39).
 ...
 *      For example: 1, 0, 126, +10.
 *
 * Debug_Test_Frame_NewPDU_NewSignal5_7ced0850fe84343b
 *   uint8 represents integers with a minimum value of 0 and a maximum value of 255.
 *      The order-relation on uint8 is: x < y if y - x is positive.
 *      uint8 has a lexical representation consisting of a finite-length sequence 
 *      of decimal digits (#x30-#x39).
 ...
 *      For example: 1, 0, 126, +10.
 *
 * Debug_Test_Frame_NewPDU_NewSignal6_44a75a04dfc7f6d0
 *   uint8 represents integers with a minimum value of 0 and a maximum value of 255.
 *      The order-relation on uint8 is: x < y if y - x is positive.
 *      uint8 has a lexical representation consisting of a finite-length sequence 
 *      of decimal digits (#x30-#x39).
 ...
 *      For example: 1, 0, 126, +10.
 *
 * Debug_Test_Frame_NewPDU_NewSignal7_47e21a3ddbf25769
 *   uint8 represents integers with a minimum value of 0 and a maximum value of 255.
 *      The order-relation on uint8 is: x < y if y - x is positive.
 *      uint8 has a lexical representation consisting of a finite-length sequence 
 *      of decimal digits (#x30-#x39).
 ...
 *      For example: 1, 0, 126, +10.
 *
 * Debug_Test_Frame_NewPDU_NewSignal8_961e244646c73622
 *   uint8 represents integers with a minimum value of 0 and a maximum value of 255.
 *      The order-relation on uint8 is: x < y if y - x is positive.
 *      uint8 has a lexical representation consisting of a finite-length sequence 
 *      of decimal digits (#x30-#x39).
 ...
 *********************************************************************************************************************/
 ...
 //static uint8 De_state;
 static uint8 EcuHw[11] = {0x12,0x34,0x1A,0x8B,0x39,0x39,0x54,0xFF,0xFF,0xFF,0xC1};
 static uint8 RT_Data[100] = {0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x10,
 ...
 static uint8 EventStatus_0x10000a = 0u;
 static uint8 EventStatus_0x40000  = 0u;
 static SG_BMC_HV_10 Send_11 ;
 ...
 static uint8 Index8;
 static uint8 Index9;
 static uint8 Index10;
 static uint8 Index11;
 static uint8 Index12;
 static uint8 Index13;
 static uint8 Index14;
 static uint8 Index15;
 static uint8 Index16;

 uint8 RT_Debug = 0;    
 uint8 RT_Debug_WR = 0;                    
 uint8 RT_Debug_u8 = 0; 
 uint8 Pim_Data[2] = {0x00,0x00};

 static uint8 Ecu_Mode = 0xFF;
 /////////////////                     CAN-FD ( HCP)           ////////////////////////
 ...
 static SG_BMC_HV_01 SG01_Data = {0x250, 0x15, 0x15, 0x16380, 0x03, 0x15, 0x03,0x03, 0x16380, 0x03, 
                                   0x6553, 0x16380,0x03, 0x253, 0x253, 0x104000, 0x127};

 static SG_BMC_HV_02 SG02_Data = { 0x250, 0x15, 0x1021, 0x1021, 0x8189, 0x03, 0x01, 0x65533, 0x8189, 
                                   0x1021, 0x01, 0x01, 0x32764,  0x8189, 0x8189, 0x07, 0x03, 0x01, 0x03,
                                    0x15, 0x03, 0x03, 0x03, 0x4093, 0x65532, 0x65532, 0x1000, 0x03, 
                                    0x03, 0x01, 0x07, 0x1000, 0x1000, 0x1000, 0x4091, 0x4091, 0x4091,
                                    0x2000, 0x1000, 0x19};
 ...
 * Debug_Test_Frame_NewPDU_NewSignal1_57aeedf7a93f27a0: Integer in interval [0...255]
 * Debug_Test_Frame_NewPDU_NewSignal2_34f600a5e6e0092e: Integer in interval [0...255]
 * Debug_Test_Frame_NewPDU_NewSignal3_19e862b5444a2f34: Integer in interval [0...255]
 * Debug_Test_Frame_NewPDU_NewSignal4_19c96f83bd5c4a32: Integer in interval [0...255]
 * Debug_Test_Frame_NewPDU_NewSignal5_7ced0850fe84343b: Integer in interval [0...255]
 * Debug_Test_Frame_NewPDU_NewSignal6_44a75a04dfc7f6d0: Integer in interval [0...255]
 * Debug_Test_Frame_NewPDU_NewSignal7_47e21a3ddbf25769: Integer in interval [0...255]
 * Debug_Test_Frame_NewPDU_NewSignal8_961e244646c73622: Integer in interval [0...255]
 * Dem_EventIdType: Integer in interval [1...65535]
 * Dem_EventStatusType: Integer in interval [0...255]
 * Door_Status_Imp: Boolean
 * EcuM_ModeType: Integer in interval [0...3]
 * EcuM_StateType: Integer in interval [0...144]
 ...
 * sysGroupSG_NewSignalGroup_a8fda00accee21d7: Array with 8 element(s) of type uint8
 *
 * Record Types:
 * =============
 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <ReadData> of PortPrototype <CBReadData_Data_StandardDTCInformation_Param_OccurCount>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   Std_ReturnType CBReadData_Data_StandardDTCInformation_Param_OccurCount_ReadData(DataPrimitiveType_uint8 *Data)
 *
 **********************************************************************************************************************
 *
 * Available Application Errors:
 * =============================
 *   RTE_E_CSDataServices_Data_StandardDTCInformation_Param_OccurCount_E_NOT_OK
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
...
FUNC(Std_ReturnType, RT_Vishnu_CODE) CBReadData_Data_StandardDTCInformation_Param_OccurCount_ReadData(P2VAR(DataPrimitiveType_uint8, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) Data) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: CBReadData_Data_StandardDTCInformation_Param_OccurCount_ReadData (returns application error)
 *********************************************************************************************************************/
   Data[0] = 12;
  return RTE_E_OK;
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: DataServices_Data_Battery_flow_temperature_Read_Data_By_Identifier_ConditionCheckRead
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_Battery_flow_temperature_Read_Data_By_Identifier_ConditionCheckRead_doc
 *********************************************************************************************************************/
...
FUNC(void, RT_Vishnu_CODE) DataServices_Data_Battery_flow_temperature_Read_Data_By_Identifier_ConditionCheckRead(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_Battery_flow_temperature_Read_Data_By_Identifier_ConditionCheckRead
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: DataServices_Data_Battery_flow_temperature_Read_Data_By_Identifier_ReadData
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * This runnable is never executed by the RTE.
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_Battery_flow_temperature_Read_Data_By_Identifier_ReadData_doc
 *********************************************************************************************************************/
...
FUNC(void, RT_Vishnu_CODE) DataServices_Data_Battery_flow_temperature_Read_Data_By_Identifier_ReadData(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_Battery_flow_temperature_Read_Data_By_Identifier_ReadData
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  Data[0] = Receive10.BJB_10_BZ;
  Data[1] = Receive10.BJB_10_CRC;
  Data[2] = Receive10.BJB_Lebensdauer_Trennelemente;
  Data[3] = Receive10.BJB_Sperrung_Unterspannung;
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: DataServices_Data_TABROW_DebugDID_Read_ConditionCheckRead
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <ConditionCheckRead> of PortPrototype <DataServices_Data_TABROW_DebugDID_Read>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   Std_ReturnType DataServices_Data_TABROW_DebugDID_Read_ConditionCheckRead(Dcm_OpStatusType OpStatus, Dcm_NegativeResponseCodeType *ErrorCode)
 *
 **********************************************************************************************************************
 *
 * Available Application Errors:
 * =============================
 *   RTE_E_DataServices_Data_TABROW_DebugDID_Read_DCM_E_PENDING
 *   RTE_E_DataServices_Data_TABROW_DebugDID_Read_E_NOT_OK
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_TABROW_DebugDID_Read_ConditionCheckRead_doc
 *********************************************************************************************************************/
...
FUNC(Std_ReturnType, RT_Vishnu_CODE) DataServices_Data_TABROW_DebugDID_Read_ConditionCheckRead(Dcm_OpStatusType OpStatus, P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) ErrorCode) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_TABROW_DebugDID_Read_ConditionCheckRead (returns application error)
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: DataServices_Data_TABROW_DebugDID_Read_ReadData
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <ReadData> of PortPrototype <DataServices_Data_TABROW_DebugDID_Read>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   Std_ReturnType DataServices_Data_TABROW_DebugDID_Read_ReadData(Dcm_OpStatusType OpStatus, uint8 *Data)
 *     Argument Data: uint8* is of type Dcm_Data100ByteType
 *
 **********************************************************************************************************************
 *
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_TABROW_DebugDID_Read_ReadData_doc
 *********************************************************************************************************************/

static uint8 CanTp_Data[100] = {0x12,0x12,0x12,0x12,0x12,0x12,0x12,0x12,0x12,0x12,
...
FUNC(Std_ReturnType, RT_Vishnu_CODE) DataServices_Data_TABROW_DebugDID_Read_ReadData(Dcm_OpStatusType OpStatus, P2VAR(uint8, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) Data) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_TABROW_DebugDID_Read_ReadData (returns application error)
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: DataServices_Data_TABROW_DebugDID_Read_WriteData
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <WriteData> of PortPrototype <DataServices_Data_TABROW_DebugDID_Read>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   Std_ReturnType DataServices_Data_TABROW_DebugDID_Read_WriteData(const uint8 *Data, Dcm_OpStatusType OpStatus, Dcm_NegativeResponseCodeType *ErrorCode)
 *     Argument Data: uint8* is of type Dcm_Data100ByteType
 *
 **********************************************************************************************************************
 *
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_TABROW_DebugDID_Read_WriteData_doc
 *********************************************************************************************************************/

static uint8 Debug_data = 0xFF;
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << End of documentation area >>                    DO NOT CHANGE THIS COMMENT!
 *********************************************************************************************************************/

FUNC(Std_ReturnType, RT_Vishnu_CODE) DataServices_Data_TABROW_DebugDID_Read_WriteData(P2CONST(uint8, AUTOMATIC, RTE_RT_VISHNU_APPL_DATA) Data, Dcm_OpStatusType OpStatus, P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) ErrorCode) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_TABROW_DebugDID_Read_WriteData (returns application error)
 *********************************************************************************************************************/
  RT_Debug_u8 = *Data;
  (void)Rte_Call_PS_NvMBlock_0x0250_WriteBlock(&RT_Debug_u8);
...
static uint8  NvM_Flag_wrt;
static SG_BMC_HV_10 BMC_10;
...
// if(NvM_Flag_wrt == 1)
// {
// (void)Rte_Call_PS_NvMBlock_0x0250_ReadBlock(&NvM_Flag);
// NvM_Flag_wrt = 0U;
// }
...
if(RT_Debug == 8)
{   
  BMC_10.BMC_HV_10_BZ = 0x0;
  BMC_10.BMC_HV_10_CRC = 0x0;
  BMC_10.BMC_Lebensdauer_Trennelemente = ReceiveUI1_01.UI1_KL30_Spannung;
  BMC_10.BMC_Sperrung_Unterspannung = ReceiveUI1_01.UI1_Strom;

  (void)Rte_Write_SG_BMC_HV_10_SG_BMC_HV_10(&BMC_10);
  
}
else if(RT_Debug == 34)
{
  (void)Rte_Write_SG_BMC_HV_10_SG_BMC_HV_10(&ReceiveUI1_02); 
 ...
 *********************************************************************************************************************/
 ...
 (void)Rte_Call_PS_NvMBlock_0x0250_ReadBlock(&RT_Debug);
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Write_Debug_Test_Frame_NewPDU_NewSignal1_57aeedf7a93f27a0_1_Debug_Test_Frame_NewPDU_NewSignal1_57aeedf7a93f27a0(Debug_Test_Frame_NewPDU_NewSignal1_57aeedf7a93f27a0 data)
 *   Std_ReturnType Rte_Write_Debug_Test_Frame_NewPDU_NewSignal2_34f600a5e6e0092e_Debug_Test_Frame_NewPDU_NewSignal2_34f600a5e6e0092e(Debug_Test_Frame_NewPDU_NewSignal2_34f600a5e6e0092e data)
 *   Std_ReturnType Rte_Write_Debug_Test_Frame_NewPDU_NewSignal3_19e862b5444a2f34_Debug_Test_Frame_NewPDU_NewSignal3_19e862b5444a2f34(Debug_Test_Frame_NewPDU_NewSignal3_19e862b5444a2f34 data)
 *   Std_ReturnType Rte_Write_Debug_Test_Frame_NewPDU_NewSignal4_19c96f83bd5c4a32_Debug_Test_Frame_NewPDU_NewSignal4_19c96f83bd5c4a32(Debug_Test_Frame_NewPDU_NewSignal4_19c96f83bd5c4a32 data)
 *   Std_ReturnType Rte_Write_Debug_Test_Frame_NewPDU_NewSignal5_7ced0850fe84343b_Debug_Test_Frame_NewPDU_NewSignal5_7ced0850fe84343b(Debug_Test_Frame_NewPDU_NewSignal5_7ced0850fe84343b data)
 *   Std_ReturnType Rte_Write_Debug_Test_Frame_NewPDU_NewSignal6_44a75a04dfc7f6d0_Debug_Test_Frame_NewPDU_NewSignal6_44a75a04dfc7f6d0(Debug_Test_Frame_NewPDU_NewSignal6_44a75a04dfc7f6d0 data)
 *   Std_ReturnType Rte_Write_Debug_Test_Frame_NewPDU_NewSignal7_47e21a3ddbf25769_Debug_Test_Frame_NewPDU_NewSignal7_47e21a3ddbf25769(Debug_Test_Frame_NewPDU_NewSignal7_47e21a3ddbf25769 data)
 *   Std_ReturnType Rte_Write_Debug_Test_Frame_NewPDU_NewSignal8_961e244646c73622_Debug_Test_Frame_NewPDU_NewSignal8_961e244646c73622(Debug_Test_Frame_NewPDU_NewSignal8_961e244646c73622 data)
 ...
 *   uint8 Rte_Mode_currentMode_currentMode(void)
 ...
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 *   Std_ReturnType Rte_Call_Event_DTC_0x10000d_SetEventStatus(Dem_EventStatusType EventStatus)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
...
static uint8 shut_var = 0xFF;
static uint8 Nvm_flag = 0xFF;
static uint8 job_status;
static uint8 written_Data[2];
static uint8 Read_Data[2];
 ...
 *********************************************************************************************************************/
  ...
  if(EventStatus_0x10000a == 1u)
  {
   ...
   /////////////////////////////////////////  Shutdown Testing /////////////////////////////////////////////////////////////////////////
     ...
     if(shut_var == 1u)
     {
     Rte_Call_EcuM_ShutdownTarget_SelectShutdownTarget(ECUM_STATE_OFF,0);
     }
     else if(shut_var ==  2u)
     {
     Rte_Call_EcuM_ShutdownTarget_SelectShutdownTarget(ECUM_STATE_RESET,0);
     }
     else if(shut_var ==  3u)
     {
     Rte_Call_EcuM_ShutdownTarget_SelectShutdownTarget(ECUM_STATE_SLEEP,0);
     }
     ...
     if(Nvm_flag == 1u)
     {
      written_Data[0] = 0x10;
      written_Data[1] = 0x20;
      Rte_Call_PS_CddNpmGen2_MeasurementsType_WriteBlock(&written_Data);
      Nvm_flag = 0u;
     }
     else if(Nvm_flag == 2u)
     {
     ...
     else if(Nvm_flag == 3u)
     {
      ...
      Nvm_flag = 0u;
               ...
               Ecu_Mode = Rte_Mode_currentMode_currentMode();
  ...
  (void)Rte_Read_IF_UI2Sens01_CALID_Index_01_DE_UI2Sens01_CALID_Index_01(&Index1);
  (void)Rte_Read_IF_UI2Sens01_CALID_Index_02_DE_UI2Sens01_CALID_Index_02(&Index2);
  (void)Rte_Read_IF_UI2Sens01_CALID_Index_03_DE_UI2Sens01_CALID_Index_03(&Index3);    
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_04_DE_UI2Sens02_CALID_Index_04(&Index4);
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_05_DE_UI2Sens02_CALID_Index_05(&Index5);
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_06_DE_UI2Sens02_CALID_Index_06(&Index6);
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_07_DE_UI2Sens02_CALID_Index_07(&Index7);
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_08_DE_UI2Sens02_CALID_Index_08(&Index8);
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_09_DE_UI2Sens02_CALID_Index_09(&Index9);
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_10_DE_UI2Sens02_CALID_Index_10(&Index10);
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_11_DE_UI2Sens02_CALID_Index_11(&Index11);
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_12_DE_UI2Sens02_CALID_Index_12(&Index12);
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_13_DE_UI2Sens02_CALID_Index_13(&Index13);
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_14_DE_UI2Sens02_CALID_Index_14(&Index14);
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_15_DE_UI2Sens02_CALID_Index_15(&Index15);
  (void)Rte_Read_IF_UI2Sens02_CALID_Index_16_DE_UI2Sens02_CALID_Index_16(&Index16);
...
#if 0
/***  Start of saved code (symbol: runnable implementation:DataServices_Data_Battery_return_flow_temperature_Read_Data_By_Identifier_ConditionCheckRead)  */
...
#if 0
/***  Start of saved code (symbol: runnable implementation:DataServices_Data_Battery_return_flow_temperature_Read_Data_By_Identifier_ReadData)  */
...
#if 0
/***  Start of saved code (symbol: documentation area:DataServices_Data_Battery_return_flow_temperature_Read_Data_By_Identifier_ConditionCheckRead_doc)  */
...
#if 0
/***  Start of saved code (symbol: documentation area:DataServices_Data_Battery_return_flow_temperature_Read_Data_By_Identifier_WriteData_doc)  */
...
#if 0
/***  Start of saved code (symbol: documentation area:DataServices_Data_Battery_return_flow_temperature_Read_Data_By_Identifier_ReadData_doc)  */
...
#if 0
/***  Start of saved code (symbol: runnable implementation:DataServices_Data_Battery_return_flow_temperature_Read_Data_By_Identifier_WriteData)  */

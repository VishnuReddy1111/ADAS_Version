 ...
 *        SW-C Type:  RT_Vishnu
 *  Generation Time:  2024-10-20 11:30:23
 *
...
FUNC(void, COM_APPL_CODE) ComTimeoutNotification_SG_BJB_11_XIX_BMC_CAN01_e2cc653e_Rx(void)
{
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_Event_DTC_0x00a00a_ResetEventStatus(void)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 *   Std_ReturnType Rte_Call_Event_DTC_0x00a00a_SetEventStatus(Dem_EventStatusType EventStatus)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 *   Std_ReturnType Rte_Call_Event_DTC_0x00a00b_ResetEventStatus(void)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 *   Std_ReturnType Rte_Call_Event_DTC_0x00a00b_SetEventStatus(Dem_EventStatusType EventStatus)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
...
static uint8 Multple_Event_Flag = 0xFF;
static uint8 reset_flag = 0xFF;
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << End of documentation area >>                    DO NOT CHANGE THIS COMMENT!
 *********************************************************************************************************************/
...
//****************************** Multiple Events mapped to single DTC ***************************/

if(Multple_Event_Flag == 1)
{
Rte_Call_Event_DTC_0x00a00a_SetEventStatus(DEM_EVENT_STATUS_FAILED);
Rte_Call_Event_DTC_0x00a00b_SetEventStatus(DEM_EVENT_STATUS_FAILED);
Multple_Event_Flag = 0u;
}
...
//************************** Resetting Already active DTC *******************************************

//Expected Goal : Resetting the Testfailedbit ( i.e. Bit 1 to 0 )

if(reset_flag == 1 )
{
  Rte_Call_Event_DTC_0x00a00a_ResetEventStatus();
  Rte_Call_Event_DTC_0x00a00b_ResetEventStatus();
  reset_flag = 0u;
}
 ...
 *********************************************************************************************************************/
 ...
 // }
  ...
  SG_11_Data.BMC_HV_11_BZ = 0x02;
  SG_11_Data.BMC_HV_11_CRC = 0x02;
...
#if 0
/***  Start of saved code (symbol: documentation area:DataServices_Data_Vishnu_DID_ReadData_doc)  ***********/
...
#if 0
/***  Start of saved code (symbol: documentation area:DataServices_Data_Vishnu_DID_WriteData_doc)  **********/
...
#if 0
/***  Start of saved code (symbol: runnable implementation:DataServices_Data_Vishnu_DID_WriteData)  *********/
...
#if 0
/***  Start of saved code (symbol: documentation area:DataServices_Data_Vishnu_DID_ConditionCheckRead_doc)  */
...
#if 0
/***  Start of saved code (symbol: runnable implementation:DataServices_Data_Vishnu_DID_ReadData)  **********/
  for(uint8 i =0;i<7;i++)
  {
    Data[i] = inc++;
  }
...
#if 0
/***  Start of saved code (symbol: runnable implementation:DataServices_Data_Vishnu_DID_ConditionCheckRead)  */

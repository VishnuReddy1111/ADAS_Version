 ...
 *
 */
 E2E_PCheckStatusType profileStatus_01;
    ...
    if (retVal == E_OK)
    {
      if (options->disableEndToEndCheck == FALSE)
      {
        ...
        if (retVal == E_OK)
        {
          ...
          /* [SWS_E2EXf_00029] */
          profileStatus_01 = E2E_P01MapStatusToSM(retVal, state->Status, options->profileBehavior);

          /* [SWS_E2EXf_00028] */
          retVal = E2E_SMCheck(profileStatus_01, smConfig, smState);

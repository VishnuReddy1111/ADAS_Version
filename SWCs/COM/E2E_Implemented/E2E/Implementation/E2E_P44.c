...
)
{
    ...
    if (ret == E2E_E_OK) 
    {
        ...
        {
            /* Do not try to change the initialization of the variables, some compilers will cause problems 
            when initializing directly via function call. See ESCAN00109888 for further information. */
            E2E_P44OffsetType offsetInBytes;
            E2E_P44LengthType receivedLength;
            E2E_P44CrcType receivedCRC;
            E2E_P44CrcType computedCRC;
            E2E_P44CounterType receivedCounter;
            E2E_P44IdType receivedDataID;

            offsetInBytes   = ConfigPtr->Offset >> 3u;
            receivedLength  = E2E_P44CheckReadLength (DataPtr, offsetInBytes); /* SBSW_E2E_03 */
            receivedCRC     = E2E_P44CheckReadCRC (DataPtr, offsetInBytes); /* SBSW_E2E_03 */
            computedCRC     = E2E_P44ComputeCRC (DataPtr, Length, offsetInBytes); /* SBSW_E2E_03 */
            receivedCounter = E2E_P44CheckReadCounter (DataPtr, offsetInBytes); /* SBSW_E2E_03 */
            receivedDataID  = E2E_P44CheckReadDataID (DataPtr, offsetInBytes); /* SBSW_E2E_03 */

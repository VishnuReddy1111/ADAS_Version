 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  RT_Vishnu.c
 *           Config:  D:/SIPs/ADAS/02_EcuCfg/ADAS.dpa
 *        SW-C Type:  RT_Vishnu
 *  Generation Time:  2024-08-09 14:27:02
 *
 ...
 *      For example: 1, 0, 126, +10.
 *
 * Dcm_RequestDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType
 *   uint8 represents integers with a minimum value of 0 and a maximum value of 255.
 *      The order-relation on uint8 is: x < y if y - x is positive.
 *      uint8 has a lexical representation consisting of a finite-length sequence 
 *      of decimal digits (#x30-#x39).
 ...
 *      For example: 1, 0, 126, +10.
 *
 * Dcm_StartDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType
 *   uint8 represents integers with a minimum value of 0 and a maximum value of 255.
 *      The order-relation on uint8 is: x < y if y - x is positive.
 *      uint8 has a lexical representation consisting of a finite-length sequence 
 *      of decimal digits (#x30-#x39).
 ...
 *      For example: 1, 0, 126, +10.
 *
 * Dcm_StopDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType
 *   uint8 represents integers with a minimum value of 0 and a maximum value of 255.
 *      The order-relation on uint8 is: x < y if y - x is positive.
 *      uint8 has a lexical representation consisting of a finite-length sequence 
 *      of decimal digits (#x30-#x39).
 ...
 *********************************************************************************************************************/
 ...
 static SG_BMC_HV_10 Send_11 = {0x1,0x12,0x13,0x22113311,0x51,0x0,0x62,0x42,0x43,0x44,0x45};
 ...
 * Dcm_RequestDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType: Integer in interval [0...255]
 * Dcm_StartDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType: Integer in interval [0...255]
 * Dcm_StopDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType: Integer in interval [0...255]
 ...
 * Dcm_RequestDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataType: Array with 1 element(s) of type Dcm_RequestDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType
 * Dcm_StartDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataType: Array with 1 element(s) of type Dcm_StartDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType
 * Dcm_StopDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataType: Array with 1 element(s) of type Dcm_StopDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType
...
BMC_HV13_Data[64];
static volatile uint8 myFlag_Tx = 0xFF;
sint64 *pdudata_Tx;
uint64 Actual_TxData = 0xFF;
uint8 CRC_Data[1] = {0xFF};
uint8 BZ_Data[4] = {0xFF};
uint8 BZ_Dec_Data;

boolean ComIPduCallout_BMC_HV_04_XIX_BMC_CAN01_E2E_a4a2e7f5_Tx(PduIdType PduId, P2VAR(PduInfoType, AUTOMATIC, COM_APPL_DATA) PduInfoPtr)
{
   pdudata_Tx = PduInfoPtr->SduDataPtr;

   uint64 Actual_TxData = *pdudata_Tx;
   


   for (uint8 i = 0; i < 64 ; i++)
	 {
       BMC_HV13_Data[i] = (Actual_TxData >> i) & 1;
    }

                               /////// CRC Test Code //////

                               
     // Signal Position -> 0 to 8  
     // Size            -> 1 Byte   

     for(uint8 i=0;i<8;i++)
     {
      CRC_Data[i] = BMC_HV13_Data[i];
     }
     uint8 CRC_Dec_Data = binval(CRC_Data,8);  // Converting Individual array Bits to Decimal 

                              /////// BZ i.e. AlvCtr Test Code //////

       //     Signal Position -> 8 to 11 
       //     Size -> 4 bits                        

     for(uint8 i=0;i<4;i++)
     {
        BZ_Data[i] = BMC_HV13_Data[i+8];
     }
    
    BZ_Dec_Data = binval(BZ_Data,4);    // // Converting Individual array Bits to Decimal
...
static volatile uint8 myFlag_Rx = 0xFF;
uint64 Actual_RxData;
sint64 *pdudata_Rx;
uint8 BJB_10_Data[8] = {0xFF};
uint16 Pduid_Rx;
boolean ComIPduCallout_BJB_10_XIX_BMC_CAN01_E2E_968516b3_Rx(PduIdType PduId, P2CONST(PduInfoType, AUTOMATIC, COM_APPL_DATA) PduInfoPtr)
{
   pdudata_Rx = PduInfoPtr->SduDataPtr;
   Actual_RxData = *pdudata_Rx;

    Pduid_Rx = PduId;   // Received PDU ID 

  for(uint8 i=0;i<64;i++)
  {
   BJB_10_Data[i] = (Actual_RxData >> i) & 1;
  }
   if(myFlag_Rx==1)
   {
    return TRUE;
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: RT_NPM_Block_Test
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: RT_NPM_Block_Test_doc
 *********************************************************************************************************************/
uint8 NPM_Flag = 5;
static uint8 NPM_Read[15];
static uint8 NPM_Write[15];
uint8 NPM_Block_Status;
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << End of documentation area >>                    DO NOT CHANGE THIS COMMENT!
 *********************************************************************************************************************/

FUNC(void, RT_Vishnu_CODE) RT_NPM_Block_Test(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: RT_NPM_Block_Test
 *********************************************************************************************************************/

 Rte_Call_PS_CddNpmGen2_MeasurementsType_GetErrorStatus(&NPM_Block_Status);
...
if(NPM_Flag == 1)
{
  for(uint8 i=0;i<15;i++)
  {
    ...
    NPM_Write[3] = 0x8;
   Rte_Call_PS_CddNpmGen2_MeasurementsType_WriteBlock(&NPM_Write);
   NPM_Flag = 0;
}
else if(NPM_Flag == 2)
{
  Rte_Call_PS_CddNpmGen2_MeasurementsType_ReadBlock(&NPM_Read);
  NPM_Flag = 0;
}
else if(NPM_Flag == 3)
{
...
{
 Rte_Call_PS_CddNpmGen2_MeasurementsType_SetRamBlockStatus(FALSE);
 NPM_Flag = 0;
}
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: RT_NV250_Block_Test
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_PS_NvMBlock_0x0250_EraseBlock(void)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *   Std_ReturnType Rte_Call_PS_NvMBlock_0x0250_GetErrorStatus(NvM_RequestResultType *ErrorStatus)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *   Std_ReturnType Rte_Call_PS_NvMBlock_0x0250_InvalidateNvBlock(void)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *   Std_ReturnType Rte_Call_PS_NvMBlock_0x0250_ReadBlock(dtRef_VOID DstPtr)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *   Std_ReturnType Rte_Call_PS_NvMBlock_0x0250_SetRamBlockStatus(boolean RamBlockStatus)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: RT_NV250_Block_Test_doc
 *********************************************************************************************************************/

uint8 NV250_Flag = 0;
static uint8 NV250_Read[10] ={0x12,0x34,0x56,0x78,0x12,0x34,0x56,0x78,0x12,0x34};
static uint8 NV250_Write[10];
uint8 NV250_Block_Status;
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << End of documentation area >>                    DO NOT CHANGE THIS COMMENT!
 *********************************************************************************************************************/

FUNC(void, RT_Vishnu_CODE) RT_NV250_Block_Test(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: RT_NV250_Block_Test
 *********************************************************************************************************************/
Rte_Call_PS_NvMBlock_0x0250_GetErrorStatus(&NV250_Block_Status);
...
if(NV250_Flag == 1)
{
  for(uint8 i=0;i<10;i++)
  {
    ...
    NV250_Write[0] = 0x1;
  Rte_Call_PS_NvMBlock_0x0250_WriteBlock(&NV250_Write);
  NV250_Flag = 0;
}
else if(NV250_Flag == 2)
{
  Rte_Call_PS_NvMBlock_0x0250_ReadBlock(&NV250_Read);
  NV250_Flag = 0;
}
else if(NV250_Flag == 3)
{
 Rte_Call_PS_NvMBlock_0x0250_EraseBlock();
 NV250_Flag = 0;
}
else if(NV250_Flag == 4)
{
 Rte_Call_PS_NvMBlock_0x0250_InvalidateNvBlock();
 NV250_Flag = 0;
}
else if(NV250_Flag == 5)
{
 Rte_Call_PS_NvMBlock_0x0250_SetRamBlockStatus(FALSE);
 NV250_Flag = 0;
}
 ...
 *   Std_ReturnType Rte_Read_IF_UI2Sens01_CALID_Index_04_DE_UI2Sens01_CALID_Index_04(uint8 *data)
 *   Std_ReturnType Rte_Read_IF_UI2Sens01_CALID_Index_05_DE_UI2Sens01_CALID_Index_05(uint8 *data)
 *   Std_ReturnType Rte_Read_IF_UI2Sens01_CALID_Index_06_DE_UI2Sens01_CALID_Index_06(uint8 *data)
 *   Std_ReturnType Rte_Read_IF_UI2Sens01_CALID_Index_07_DE_UI2Sens01_CALID_Index_07(uint8 *data)
 *   Std_ReturnType Rte_Read_IF_UI2Sens01_CALID_Index_08_DE_UI2Sens01_CALID_Index_08(uint8 *data)
 *
 * Output Interfaces:
 * ==================
 *   Explicit S/R API:
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_Event_DTC_0x10000a_GetFaultDetectionCounter(sint8 *FaultDetectionCounter)
 *     Synchronous Service Invocation. Timeout: None
 ...
 *********************************************************************************************************************/
  ...
  {
   Rte_Call_Event_DTC_0x10000a_SetEventStatus(DEM_EVENT_STATUS_PASSED);
  }

/*******************************    FDC  ********************************************************/

     Rte_Call_Event_DTC_0x10000a_GetFaultDetectionCounter(&FDC);
  ...
  (void)Rte_Write_SG_BMC_HV_10_SG_BMC_HV_10(&Send_11);
 ...
 //////////////////////////////////////////////////   Callout test  /////////////////////////////////
      ...
      (void)Rte_Read_IF_UI2Sens01_CALID_Index_01_DE_UI2Sens01_CALID_Index_01(&Sig1);
      (void)Rte_Read_IF_UI2Sens01_CALID_Index_02_DE_UI2Sens01_CALID_Index_02(&Sig2);
      (void)Rte_Read_IF_UI2Sens01_CALID_Index_03_DE_UI2Sens01_CALID_Index_03(&Sig3);
      (void)Rte_Read_IF_UI2Sens01_CALID_Index_04_DE_UI2Sens01_CALID_Index_04(&Sig4);
      (void)Rte_Read_IF_UI2Sens01_CALID_Index_05_DE_UI2Sens01_CALID_Index_05(&Sig5);
      (void)Rte_Read_IF_UI2Sens01_CALID_Index_06_DE_UI2Sens01_CALID_Index_06(&Sig6);
      (void)Rte_Read_IF_UI2Sens01_CALID_Index_07_DE_UI2Sens01_CALID_Index_07(&Sig7);
      (void)Rte_Read_IF_UI2Sens01_CALID_Index_08_DE_UI2Sens01_CALID_Index_08(&Sig8);
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_RequestResults
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <RequestResults> of PortPrototype <RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   Std_ReturnType RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_RequestResults(Dcm_OpStatusType OpStatus, Dcm_RequestDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType *ResData, Dcm_NegativeResponseCodeType *ErrorCode)
 *     Argument ResData: Dcm_RequestDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType* is of type Dcm_RequestDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataType
 *
 **********************************************************************************************************************
 *
 * Available Application Errors:
 * =============================
 *   RTE_E_RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_DCM_E_FORCE_RCRRP
 *   RTE_E_RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_DCM_E_PENDING
 *   RTE_E_RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_E_NOT_OK
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_RequestResults_doc
 *********************************************************************************************************************/
...
FUNC(Std_ReturnType, RT_Vishnu_CODE) RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_RequestResults(Dcm_OpStatusType OpStatus, P2VAR(Dcm_RequestDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) ResData, P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) ErrorCode) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_RequestResults (returns application error)
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_Start
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <Start> of PortPrototype <RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   Std_ReturnType RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_Start(Dcm_OpStatusType OpStatus, Dcm_StartDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType *ResData, Dcm_NegativeResponseCodeType *ErrorCode)
 *     Argument ResData: Dcm_StartDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType* is of type Dcm_StartDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataType
 *
 **********************************************************************************************************************
 *
 * Available Application Errors:
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_Start_doc
 *********************************************************************************************************************/
...
FUNC(Std_ReturnType, RT_Vishnu_CODE) RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_Start(Dcm_OpStatusType OpStatus, P2VAR(Dcm_StartDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) ResData, P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) ErrorCode) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_Start (returns application error)
 *********************************************************************************************************************/
  Rte_Call_PS_NvMBlock_0x0250_InvalidateNvBlock();
  return RTE_E_OK;
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_Stop
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <Stop> of PortPrototype <RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   Std_ReturnType RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_Stop(Dcm_OpStatusType OpStatus, Dcm_StopDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType *ResData, Dcm_NegativeResponseCodeType *ErrorCode)
 *     Argument ResData: Dcm_StopDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType* is of type Dcm_StopDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataType
 *
 **********************************************************************************************************************
 *
 * Available Application Errors:
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_Stop_doc
 *********************************************************************************************************************/
...
FUNC(Std_ReturnType, RT_Vishnu_CODE) RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_Stop(Dcm_OpStatusType OpStatus, P2VAR(Dcm_StopDataOut_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_ResDataArrayType, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) ResData, P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, RTE_RT_VISHNU_APPL_VAR) ErrorCode) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: RoutineServices_Routine_DiagnServi_TABROW_ResetOfContaError_Start_Routine_Stop (returns application error)
 *********************************************************************************************************************/
...
{
  (void)Rte_Call_PS_CddNpmGen2_MeasurementsType_WriteBlock(&error_counter);   
}

 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  RT_Vishnu.c
 *           Config:  D:/SIPs/CARIAD/Working/ADAS/02_EcuCfg/ADAS.dpa
 *        SW-C Type:  RT_Vishnu
 *  Generation Time:  2024-09-29 00:30:24
 *
 ...
 *********************************************************************************************************************/
 ...
 static uint8 debounce_flag  = 0u;
 //static uint8 Event_0x00a00a  = 0u;
 static uint8 Event = 0u;
 static uint8 counter = 0;
 static uint8 opcycle_flag_RT = 0u;
 //static uint8 opcycle_powercycle = 0u;
 static uint8 Debounce_counter_up = 0u;
 static uint8 Debounce_counter_down = 0u;
 static uint8 dummy_1;
 ...
 //static uint8 RT_Ram_Pim_Data[2] = {0x00,0x00};  
 ...
 //static SG_BMC_HV_02 SG02_Data = { 0x250, 0x15, 0x1021, 0x1021, 0x8189, 0x03, 0x01, 0x65533, 0x8189, 
  ...
  static uint8 Current_EcuMode = 0xFF;                                  
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: Dem_GeneralEventInfo_Runnable
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: Dem_GeneralEventInfo_Runnable_doc
 *********************************************************************************************************************/
...
FUNC(void, RT_Vishnu_CODE) Dem_GeneralEventInfo_Runnable(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: Dem_GeneralEventInfo_Runnable
 *********************************************************************************************************************/
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_Event_DTC_0x00a00a_SetEventStatus(Dem_EventStatusType EventStatus)
 *     Synchronous Service Invocation. Timeout: None
 ...
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 *   Std_ReturnType Rte_Call_EvtInfo_DTC_0x10000a_GetDebouncingOfEvent(Dem_DebouncingStateType *DebouncingState)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticInfo_E_NOT_OK
 *   Std_ReturnType Rte_Call_EvtInfo_DTC_0x10000a_GetFaultDetectionCounter(sint8 *FaultDetectionCounter)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticInfo_DEM_E_NO_FDC_AVAILABLE, RTE_E_DiagnosticInfo_E_NOT_OK
 *   Std_ReturnType Rte_Call_EvtInfo_DTC_0xe40000_GetDebouncingOfEvent(Dem_DebouncingStateType *DebouncingState)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticInfo_E_NOT_OK
 *   Std_ReturnType Rte_Call_EvtInfo_DTC_0xe40000_GetFaultDetectionCounter(sint8 *FaultDetectionCounter)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticInfo_DEM_E_NO_FDC_AVAILABLE, RTE_E_DiagnosticInfo_E_NOT_OK
 *   Std_ReturnType Rte_Call_K15State_SetK15State(boolean state)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_CddNpmGen2_K15State_E_NOT_OK
 *   Std_ReturnType Rte_Call_OpCycle_DemOperationRT_SetOperationCycleState(Dem_OperationCycleStateType CycleState)
 *     Synchronous Service Invocation. Timeout: None
...
sint8 FDC_0x10000a = 0u;
sint8 FDC_0x400000 = 0u;
uint8 DebounceState0xe40000 =0u;
uint8 DebounceState0x10000a =0u;


//#define DEM_OPERATIONCYCLE_CYCLE_STARTED         (0x02U)
//#define DEM_OPERATIONCYCLE_CYCLE_STOPPED         (0x01U)
...
void ComInvalidNotification_SG_BJB_10_XIX_BMC_CAN01_5b37bed6_Rx(void)
{
  dummy_1 = 0;
}
void  ComInvalidNotification_SG_BJB_11_XIX_BMC_CAN01_e2cc653e_Rx(void)
{
   dummy_1 = 1;
}

void ComNotification_SG_BMC_HV_10_XIX_BMC_CAN01_284dd772_Tx()
{
  dummy_1 = 2;
}

void ComNotification_SG_BJB_10_XIX_BMC_CAN01_5b37bed6_Rx()
{
 ...
 *********************************************************************************************************************/
   ...
   //****************************   DEM_Implementation  ***************************//
    ...
    //************************************   Counter Debouncing 0xe40000  ****************************************

    // Debouncing counter = 3 (Both pass and failed threshold )
    // Incrementing counter = 1 at every step 
    // Debounce_counter_up  -  To confirm the incremented debounce counter
    // Debounce_counter_down - To confirm the decremented debounce counter

  if(debounce_flag == 1u)  // step 1 
  {
  Rte_Call_Event_DTC_0xe40000_SetEventStatus(DEM_EVENT_STATUS_PREFAILED);
  debounce_flag = 0u;
  Debounce_counter_up = 1;
  }
  else if(debounce_flag == 2u)  // step 2 
  {
  Rte_Call_Event_DTC_0xe40000_SetEventStatus(DEM_EVENT_STATUS_PREFAILED);
  debounce_flag = 0u;
  Debounce_counter_up = 2;
  }
  else if(debounce_flag == 3u)  // step 3  -- Event will be confirmed 
  {
  Rte_Call_Event_DTC_0xe40000_SetEventStatus(DEM_EVENT_STATUS_PREFAILED);
  debounce_flag = 0u;
  Debounce_counter_up = 3;
  }
  else if(debounce_flag == 4u) // step 4 - to test 
  {
  Rte_Call_Event_DTC_0xe40000_SetEventStatus(DEM_EVENT_STATUS_PREPASSED);
  debounce_flag = 0u;
  Debounce_counter_down = 1u;
  }
  else if(debounce_flag == 5u) // step 5 
  {
  Rte_Call_Event_DTC_0xe40000_SetEventStatus(DEM_EVENT_STATUS_PREPASSED);
  debounce_flag = 0u;
   Debounce_counter_down = 2u;
  }
   else if(debounce_flag == 6u) // step 6 - After this step , Bit 0 will set to 0, i.e. Passive DTC
  {
  Rte_Call_Event_DTC_0xe40000_SetEventStatus(DEM_EVENT_STATUS_PREPASSED);
  debounce_flag = 0u;
   Debounce_counter_down = 3u;
  }
  
   //        ******************  FDC  **************************\\

  Rte_Call_EvtInfo_DTC_0xe40000_GetFaultDetectionCounter(&FDC_0x400000);
  Rte_Call_EvtInfo_DTC_0xe40000_GetDebouncingOfEvent(&DebounceState0xe40000);

 //************************************************************* Timer based Debouncing *****************************************************\\

 // Failed Threshold - 200ms
 // Passed Threshold - 300ms
...
/// 1. Set the event -> DTC will be active
/// 2. Reset the event -> DTC will be passive
/// 3. Start the operation cycle 
/// 4. Stop the operation cycle
/// 5. Repeat incrementing the operation cycle until it matches with aging counter


  //  ***********************************  DTC setting for Aging Test  **************************\\
 ...
 //  ***********************************  FDC  **************************\\
    ...
    Rte_Call_EvtInfo_DTC_0x10000a_GetFaultDetectionCounter(&FDC_0x10000a);
    Rte_Call_EvtInfo_DTC_0x10000a_GetDebouncingOfEvent(&DebounceState0x10000a);
   

 
  // *************************************  Operation Cycle Start and Stop ***********************************
  
      if(opcycle_flag_RT == 1u)  // step 3 
      {
     Rte_Call_OpCycle_DemOperationRT_SetOperationCycleState(DEM_CYCLE_STATE_START);
     opcycle_flag_RT = 0u;
      }
      else if(opcycle_flag_RT == 2u) // step 4 
      {
      Rte_Call_OpCycle_DemOperationRT_SetOperationCycleState(DEM_CYCLE_STATE_END);
      opcycle_flag_RT = 0u;
      }
  ...
  SG_10_data.BMC_HV_10_CRC = 0x10;
  SG_10_data.BMC_HV_10_BZ = counter++; 
  if(counter == 255u)    
  {
    counter = 0u;
  }                 
  ...
  //*************************************** Current ECU Mode ***************************************\\
    ...
    Current_EcuMode = Rte_Mode_currentMode_currentMode();
